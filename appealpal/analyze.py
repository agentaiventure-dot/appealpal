...
SYSTEM = (
    ...
    "deadline_quote (string, verbatim sentence about the appeal deadline, or empty), "
    "deadline_days (integer NUMBER OF CALENDAR DAYS ONLY; if the letter's window is stated in hours, weeks or months, "
    "convert it to the equivalent number of days (round down); if you cannot tell the unit, set this to 0 and rely on "
    "deadline_quote for the exact wording; never confuse hours with days), "
